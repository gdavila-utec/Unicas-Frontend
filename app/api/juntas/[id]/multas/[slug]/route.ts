...
export async function DELETE(
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/multas/${params.slug}/`,
      {
        method: 'DELETE',
        headers: {
...
export async function PUT(
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/multas/${params.id}`,
      {
        method: 'PUT',
        headers: {
